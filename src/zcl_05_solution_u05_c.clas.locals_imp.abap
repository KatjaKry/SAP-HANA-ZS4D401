...
CLASS lcl_passenger_flight DEFINITION .
  ...
  PRIVATE SECTION.
    ...
    CLASS-DATA connections_buffer TYPE TABLE OF st_connections_buffer.  " Privat static attribute connections_buffer - it's an Internal table type with type as row st_connections_buffer
