CLASS zcl_05_solution_u19 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_05_SOLUTION_U19 IMPLEMENTATION.
...
*     CONSTANTS c_carrier_id TYPE /dmo/carrier_id VALUE 'UA'.
    ...
    TRY.
      ...
      catch cx_abap_auth_check_exception  INTO data(lx_excp).
        " out->write( lx_excp->get_text(  ) ).       "Übung 18
